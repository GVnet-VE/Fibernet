					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizar Sub Categoría</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Nombre de Sub Categoría</label>
<div class="controls">
<input type="text" placeholder="Ingrese nombre de Sub categoría"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>
