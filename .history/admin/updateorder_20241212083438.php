...
$ret = mysqli_query($con,"SELECT * FROM ordertrackhistory WHERE orderId='$oid'");
     ...
     <tr height="20">
      <td  class="fontkink1"><b>Comentarios:</b></td>
...
$st='Delivered';
   ...
   <tr><td colspan="2"><b>
      Orden Atendida </b></td>
      <td  class="fontkink"> <input name="Submit2" type="submit" class="txtbox4" value="Cerrar Ventana " onClick="return f2();" style="cursor: pointer;"  /></td>
   ...
   <?php }else  {
    ...
    <tr height="50">
     ...
     <tr style=''>
      <td class="fontkink1" >Comentarios:</td>
