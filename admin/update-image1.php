...
$_SESSION['msg']="La imágen se actualizó satisfactoriamente !!";
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Actualizar Imagen 1 de Producto</h3>
								<button class="btn"><a href="edit-products.php?id=<?php echo $pid;?>">Regresar</button>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imágen 1 actual</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Nueva Imágen 1</label>
<div class="controls">
...
<?php } ?>
	...
	<div class="control-group">
											<div class="controls">
												...
												<button class="btn"><a href="edit-products.php?id=<?php echo $pid;?>">Cancelar</button>
											</div>
										</div>
									</form>
							</div>
