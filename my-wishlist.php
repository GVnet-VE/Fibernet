...
<html lang="en">
	<head>
	    ...
	    <title>CashNet | Lista de Deseos</title>
...
?>
						...
						<div class="rating">
							...
							<span class="review">( <?php echo htmlentities($num);?> Opiniones )</span>
						</div>
						<?php } ?>
						<div class="price">REF. 
					...
					<td class="col-md-2 close-btn">
						<a href="my-wishlist.php?del=<?php echo htmlentities($row['wid']);?>" onClick="return confirm('Esta seguro de borrar?')" class=""><i class="fa fa-times"></i></a>
					</td>
				</tr>
				<?php } } else{ ?>
				<tr>
