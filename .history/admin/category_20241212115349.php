...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="Categoria Borrada !!";
		  }
...
?>									
										<tr>
											...
											<a href="category.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Está seguro de eliminar esta categoría?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
