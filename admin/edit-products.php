									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										?>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="productName" placeholder="Ingrese en Nombre del Producto" value="<?php echo htmlentities($row['productName']); ?>" class="span8 tip">
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="productCompany" placeholder="Ingrese en Nombre de Compañia" value="<?php echo htmlentities($row['productCompany']); ?>" class="span8 tip" required>
												</div>
											</div>
											<div class="control-group">
												<label class="control-label" for="basicinput">Precio del Producto antes de Descuento</label>
												<div class="controls">
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Descripión del Producto</label>
												<div class="controls">
...
<?php echo htmlentities($row['productDescription']); ?>
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Cargos por Envíos del Producto</label>
												<div class="controls">
													<input type="text" name="productShippingcharge" placeholder="Ingrese Cargos de Envío" value="<?php echo htmlentities($row['shippingCharge']); ?>" class="span8 tip" required>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<img src="productimages/<?php echo htmlentities($row['productImage1']); ?>" width="200" height="100"> <a href="update-image1.php?id=<?php echo $row['id']; ?>">Cambiar Imagen</a>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<img src="productimages/<?php echo htmlentities($row['productImage2']); ?>" width="200" height="100"> <a href="update-image2.php?id=<?php echo $row['id']; ?>">Cambiar Imagen</a>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<img src="productimages/<?php echo htmlentities($row['productImage3']); ?>" width="200" height="100"> <a href="update-image3.php?id=<?php echo $row['id']; ?>">Cambiar Imagen</a>
												</div>
											</div>
										<?php } ?>
										<div class="control-group">
											<div class="controls">
												...
												<button class="btn"><a href="manage-products.php">Cancelar</button>
											</div>
										</div>
									</form>
								</div>
