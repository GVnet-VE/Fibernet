...
echo "<script>alert('El password se actualizó correctamente !!');</script>";
}
else
{
...
{
alert("El campo Nuevo Password esta vacio !!");
document.chngpwd.newpass.focus();
return false;
}
else if(document.chngpwd.cnfpass.value=="")
{
alert("El campo Confirmar Password esta vacio !!");
document.chngpwd.cnfpass.focus();
return false;
}
else if(document.chngpwd.newpass.value!= document.chngpwd.cnfpass.value)
{
alert("El campo Password y Confirmar Password no coinciden  !!");
document.chngpwd.cnfpass.focus();
return false;
}
return true;
...
<div class="form-group">
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">Actualiza</button>
					</form>
					<?php } ?>
				</div>	
...
<div class="form-group">
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  ...
					  <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">Cambiar Password </button>
					</form> 
