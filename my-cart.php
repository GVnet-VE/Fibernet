...
// code for billing address updation
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('Su Direccion de Cobro ha sido Actualizada');</script>";
		}
	}
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		if($query)
		{
echo "<script>alert('Su Direccion de Envío ha sido Actualizada');</script>";
		}
	}
...
<html lang="es">
	<head>
	    ...
	    <title>CashNet | Carrito de Compra</title>
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-sub-total item">Cargos de Envío</th>
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="admin/productimages/<?php echo $row['productImage1'];?>" alt="" width="100" height="200">
						</a>
					</td>
...
?>
								<div class="reviews">
									( <?php echo htmlentities($num);?> Opiniones )
								</div>
								<?php } ?>
							</div>
						</div><!-- /.row -->
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "REF."." ".$row['productPrice']; ?></span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "REF."." ".$row['shippingCharge']; ?></span></td>
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Dirección de Cobro<span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Codigo <span>*</span></label>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Dirección de Cobro</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Código <span>*</span></label>
...
<div class="col-md-4 col-sm-12 cart-shopping-total">
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">COMPRAR</button>
	...
	<?php } else {
echo "Su Carrito  de compra está vacio";
		}?>
</div>			</div>
		</div> 
		</form>
