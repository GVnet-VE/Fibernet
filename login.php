...
{
alert("El Password y la Confirmación del Password no coinciden!!");
...
<div class="col-md-6 col-sm-6 sign-in">
	...
	?>
		...
		<div class="radio outer-xs">
		  	<a href="forgot-password.php" class="forgot-password pull-right">Olvidó su password?</a>
		</div>
