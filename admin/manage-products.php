...
?>									
										<tr>
											...
											<a href="manage-products.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Está seguro de borrar el producto?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
