...
if (isset($_GET['pid']) && $_GET['action'] == "wishlist") {
	if (strlen($_SESSION['login']) == 0) {
		...
		echo "<script>alert('El Producto se ha agregado a la lista de deseos');</script>";
...
<head>
	...
	<title>CashNet | Detalles de Productos</title>
								...
								<div class="product-info">
									...
									<div class="price-container info-container m-t-20">
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="price-box">
													<span class="price">REF. <?php echo htmlentities($row['productPrice']); ?></span>
													<!-- <span class="price-strike">REFs.<?php echo htmlentities($row['productPriceBeforeDiscount']); ?></span> -->
												</div>
											</div>
									...
									<div class="quantity-container info-container">
										<div class="row">
											...
											<div class="col-sm-7">
												<?php if ($row['productAvailability'] == 'En Existencia') { ?>
									...
									<div class="price-container info-container m-t-20">
										<div class="row">
											...
											<div class="col-sm-7">
												...
												<a href="product-credits.php?id=<?php echo $pid; ?>" class="btn btn-primary"><i class="fa fa-credit-card inner-right-vs"></i>Planes de Credito</a>
					...
					<div class="products">
						<div class="product">
							<div class="product-image">
								<div class="image">
									<a href="product-details.php?pid=<?php echo htmlentities($rw['id']); ?>"><img src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['productImage1']); ?>" width="200" height="230" alt=""></a>
								</div><!-- /.image -->
