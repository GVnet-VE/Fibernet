...
<html lang="en">
	<head>
	    ...
	    <title>CashNet | Rastreo de Compras</title>
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Rastreo de Compras</li>
			</ul>
...
<div class="body-content outer-top-bd">
	<div class="container">
		<div class="track-order-page inner-bottom-sm">
			<div class="row">
				<div class="col-md-12">
	<h2>Rastrea tu Compra</h2>
	<span class="title-tag inner-top-vs">Por favor ingrese su numero de compra en la casilla de abajo y presione ENVIAR. Este número se le proporcionó en su recibo y en el correo electrónico de confirmación que debería haber recibido. </span>
	<form class="register-form outer-top-xs" role="form" method="post" action="order-details.php">
		<div class="form-group">
		    <label class="info-title" for="exampleOrderId1">Numero de Compra</label>
