...
<head>
	...
	<title>Administración| Ordenes Entregadas</title>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display table-responsive" >
									<thead>
										<tr>
											<th>No</th>
											<th> Nombre</th>
											<th width="50">e-mail / Teléfono</th>
											<th>Dirección</th>
											<th>Producto </th>
											<th>Cant. </th>
											<th>Monto </th>
...
?>										
										<tr>
											...
											<td> <a href="updateorder.php?oid=<?php echo htmlentities($row['id']);?>" title="Actualizar Orden" target="_blank"><i class="icon-edit"></i></a>
											</td>
											</tr>
