...
<html lang="en">
	<head>
	    ...
	    <title>CashNet | Información de Credito</title>
...
?>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="admin/productimages/<?php echo htmlentities($rws['productImage1']);?>"  width="200" height="400" alt="">
							</div>
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									REF. <?php echo htmlentities($rws['productPrice']);?>
								</span>
									
							    <!-- <span class="price-before-discount">REF.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>					 -->
						...
						<div class="cart clearfix animate-effect">
							<div class="action">
								...
								<div class="add-cart-button btn-group">
									...
									<?php if($rws['productAvailability']=='En Existencia'){?>
										<button class="btn btn-primary icon" data-toggle="dropdown" type="button">
							...
							<button class="btn btn-primary" type="button">Agregar al carrito</button></a>
								<?php } else {?>
							<div class="action" style="color:red">Fuera de Existencia</div>
					<?php } ?>
            ...
            <div class="item">
                ...
                <div class="item">
                    ...
                    <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="3" href="#slide3">
                        <img class="img-responsive" width="85" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['productImage3']);?>"/>
                    </a>
                </div>
						...
						<div class="product-info">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price"><?php echo number_format(($row['productPrice'])*0.30, 2, ',', '.');?></span>
                                ...
                                <div class="row">
									...
									<div class="col-sm-7" style="border: 2px solid red; margin-bottom: 10px;">
										<div class="price-box">
                                            <h4 class="name">Credito a 3 meses</h4>
											<span class="price"><?php echo htmlentities (round((($row['productPrice'])*0.70/3),2));?></span><h4 class="name">Mensual</h4>
										</div>
									</div>
                                    
                                    <div class="col-sm-7" style="border: 2px solid red; margin-bottom: 10px;">
										<div class="price-box">
                                            <h4 class="name">Credito a 6 meses</h4>
											<span class="price"><?php echo htmlentities (round((($row['productPrice'])*0.70/6),2));?></span><h4 class="name">Mensual</h4>
										</div>
									</div>
                                    
                                    <div class="col-sm-7" style="border: 2px solid red; margin-bottom: 10px;">
										<div class="price-box">
                                            <h4 class="name">Credito a 9 meses</h4>
											<span class="price"><?php echo htmlentities (round((($row['productPrice'])*0.70/9),2));?></span><h4 class="name">Mensual</h4>
										</div>
									</div>
                                    
                                    <div class="col-sm-7" style="border: 2px solid red; margin-bottom: 10px;">
										<div class="price-box">
                                            <h4 class="name">Credito a 12 meses</h4>
											<span class="price"><?php echo htmlentities (round((($row['productPrice'])*0.70/12),2));?></span><h4 class="name">Mensual</h4>
										</div>
									</div>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								...
								<li><a data-toggle="tab" href="#review">OPINIONES</a></li>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">Opinion de Clientes</h4>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Calidad :</b>  <?php echo htmlentities($rvw['quality']);?> Star</div>
													...
													<table class="table table-bordered">	
														<thead>
															<tr>
																...
																<th>1 <i class="fa fa-star" style="color: orange"></i></th>
																<th>2 <i class="fa fa-star" style="color: orange"></i></th>
																<th>3 <i class="fa fa-star" style="color: orange"></i></th>
																<th>4 <i class="fa fa-star" style="color: orange"></i></th>
																<th>5 <i class="fa fa-star" style="color: orange"></i></th>
															</tr>
														</thead>	
														<tbody>
															<tr>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><img  src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($rw['productImage1']);?>" width="150" height="240" alt=""></a>
			</div><!-- /.image -->			
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					REF.<?php echo htmlentities($rw['productPrice']);?>			</span>
